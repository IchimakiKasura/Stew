...
function rewriteHTML(html, rel) {
    ...
    if (!isProd && !isTest) return html; // Fixed logic bug (changed || to &&)
    ...
    // change turnstile key from dev/test key to public key
    html = html.replace("3x00000000000000000000FF", "0x4AAAAAADoVwwXvQ7eTM75Q");
